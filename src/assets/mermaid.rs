...
///
/// Parses the Mermaid syntax, renders to SVG, applies theme overrides (dark background,
/// purple text), then rasterizes to PNG. Results are cached by source + max_width.
